...
function formatLength(length, { c: c4 = 1, offset = 0, attachPx = true } = {}) {
  if (typeof length === "number") {
    const result = (length + offset) * c4;
    if (result === 0)
      return "0";
    return `${result}px`;
  } else if (typeof length === "string") {
    if (pureNumberRegex.test(length)) {
      const result = (Number(length) + offset) * c4;
      if (attachPx) {
        if (result === 0)
          return "0";
        return `${result}px`;
      ...
      if (!result)
        return length;
      return length.replace(numberRegex, String((Number(result[0]) + offset) * c4));
    }
  }
  return length;
}
...
function insideModal(style3) {
  return c2(({ props: { bPrefix } }) => `${bPrefix || prefix}modal, ${bPrefix || prefix}drawer`, [style3]);
}
function insidePopover(style3) {
  return c2(({ props: { bPrefix } }) => `${bPrefix || prefix}popover`, [style3]);
}
function asModal(style3) {
  return c2(({ props: { bPrefix } }) => `&${bPrefix || prefix}modal`, style3);
}
var cCB = (...args) => {
  return c2(">", [cB(...args)]);
};
...
var init2 = () => {
  var _a, _b;
  fontsReady = isBrowser2 ? (_b = (_a = document) === null || _a === void 0 ? void 0 : _a.fonts) === null || _b === void 0 ? void 0 : _b.ready : void 0;
  isFontReady = false;
...
var ZIndexManager = class {
  ...
  unregister(el, zIndex) {
    ...
    if (elementZIndex.has(el)) {
      ...
      warn2("z-index-manager/unregister-element", "Element not found when unregistering.");
    }
    this.squashState();
  }
  squashState() {
...
function useOnResize(elRef, onResize) {
  if (onResize) {
    onMounted(() => {
      ...
      if (el) {
        delegate_default.registerHandler(el, onResize);
      }
    });
    onBeforeUnmount(() => {
      const { value: el } = elRef;
      if (el) {
        delegate_default.unregisterHandler(el);
      }
    });
  }
}
...
var lockHtmlScrollRightCompensationRef = ref("0px");
...
//# sourceMappingURL=chunk-RNMXTDAF.js.map
